...
class BaseTest(unittest.TestCase):
    def setUp(self):
        ...
        self.config.scan('.views.api') # Scan specific API views
...
class UserAPITests(BaseTest):
    def test_register_user_success(self):
        from .views.api import register_user
    ...
    def test_login_user_success(self):
        from .views.api import login_user
        request = _get_app_request(self.dbsession)
        request.json_body = {
            'email': self.test_user_email,
    ...
    def test_logout_user_success(self):
        from .views.api import logout_user
    ...
    def test_get_users_success(self):
        from .views.api import get_users
        request = _get_app_request(self.dbsession)
    ...
    def test_get_user_by_id_success(self):
        from .views.api import get_user
        request = _get_app_request(self.dbsession)
    ...
    def test_update_user_success(self):
        from .views.api import update_user
        request = _get_app_request(self.dbsession)
        request.matchdict['id'] = str(self.test_user_id)
        request.json_body = {
            'phone': '9876543210',
    ...
    def test_delete_user_success(self):
        from .views.api import delete_user
        request = _get_app_request(self.dbsession)
        request.matchdict['id'] = str(self.test_user_id)
...
class BrandAPITests(BaseTest):
    def test_get_brands_success(self):
        from .views.api import get_brands
        request = _get_app_request(self.dbsession)
    ...
    def test_create_brand_success(self):
        from .views.api import create_brand
        request = _get_app_request(self.dbsession)
    ...
    def test_update_brand_success(self):
        from .views.api import update_brand
        request = _get_app_request(self.dbsession)
    ...
    def test_delete_brand_success(self):
        from .views.api import delete_brand
        request = _get_app_request(self.dbsession)
        request.matchdict['id'] = str(self.test_brand_id)
...
class ProductAPITests(BaseTest):
    def test_get_products_success(self):
        from .views.api import get_products
        request = _get_app_request(self.dbsession)
    ...
    def test_create_product_success(self):
        from .views.api import create_product
        request = _get_app_request(self.dbsession)
        request.json_body = {
            'name': 'New Shoe',
    ...
    def test_get_product_by_id_success(self):
        from .views.api import get_product
        request = _get_app_request(self.dbsession)
    ...
    def test_update_product_success(self):
        from .views.api import update_product
        request = _get_app_request(self.dbsession)
        request.matchdict['id'] = str(self.test_product_id)
        request.json_body = {
            'price': 110.00,
    ...
    def test_delete_product_success(self):
        from .views.api import delete_product
        request = _get_app_request(self.dbsession)
        request.matchdict['id'] = str(self.test_product_id)
...
class TransactionAPITests(BaseTest):
    def test_get_transactions_success(self):
        from .views.api import get_transactions
    ...
    def test_create_transaction_logged_in_success(self):
        from .views.api import create_transaction
    ...
    def test_get_transaction_by_id_success(self):
        from .views.api import get_transaction
    ...
    def test_update_transaction_status_success(self):
        from .views.api import update_transaction_status
        transaction_id = uuid.uuid4()
        new_transaction = Transaction(
            id=transaction_id,
            user_id=self.test_user_id,
    ...
    def test_delete_transaction_success(self):
        from .views.api import delete_transaction
        transaction_id = uuid.uuid4()
        new_transaction = Transaction(
            id=transaction_id,
            user_id=self.test_user_id,
...
class FavoriteAPITests(BaseTest):
    def test_get_favorites_authenticated_success(self):
        from .views.api import get_favorites
    ...
    def test_add_favorite_success(self):
        from .views.api import add_favorite
    ...
    def test_remove_favorite_success(self):
        from .views.api import remove_favorite
...
class InspirationAPITests(BaseTest):
    def test_get_inspirations_success(self):
        from .views.api import get_inspirations
        request = _get_app_request(self.dbsession)
    ...
    def test_create_inspiration_success(self):
        from .views.api import create_inspiration
        request = _get_app_request(self.dbsession)
        request.json_body = {
    ...
    def test_get_inspiration_by_id_success(self):
        from .views.api import get_inspiration
        request = _get_app_request(self.dbsession)
    ...
    def test_update_inspiration_success(self):
        from .views.api import update_inspiration
        request = _get_app_request(self.dbsession)
        request.matchdict['id'] = str(self.test_inspiration_id)
        request.json_body = {
    ...
    def test_delete_inspiration_success(self):
        from .views.api import delete_inspiration
        request = _get_app_request(self.dbsession)
        request.matchdict['id'] = str(self.test_inspiration_id)
